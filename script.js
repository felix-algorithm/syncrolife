...
const apkDownloadUrl = "https://github.com/felix-algorithm/test/releases/download/v1.0.0/syncrolife.apk";
...
emailForm?.addEventListener("submit", (event) => {
  ...
  formMessage.textContent = "Đã ghi nhận email. Bạn sẽ nhận thông báo beta sớm nhất.";
  emailForm.reset();
});
